<?php
session_start();
if( isset($_SESSION['usa2sa_myusername']))
{
              ...
              <div class="modal-body">
                  <form method="post" action="USA2SA_registerlogin.php">
                      <div class="input-group">
                          ...
                          <input type="email" name = "e-mail"  id ="e-mail" required class="form-control" placeholder="Enter E-mail address" aria-describedby="basic-addon1">
                      </div>
                      <span size="6" class="bspan" id="mailinfo"></span><br>
                      ...
                      <hr>
                      <button disabled = "disabled" type="submit" class="btn btn-primary" id= "register-submit">Register Now!</button>
                  </form>
                </div>
              </div>
            </div>
      ...
      <div class="container"> 
        ...
        <div class="nav-collapse collapse"> 
          ...
          <div class = "nav pull-right" data-toggle="modal" data-target="#myModal">
              <li><a href="#myModal">Register</a></li>
          </div>
          <div class = "nav pull-right">
